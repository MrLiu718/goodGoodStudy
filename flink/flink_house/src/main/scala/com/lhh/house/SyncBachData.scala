...
/**
  * @description
  * @author: liuhh
  * @date: Created in 2020/3/8 21:13
  * @version 0.0.1
  */
object SyncBachData {
  def main(args: Array[String]): Unit = {
    ...
    val inputFormat: JDBCInputFormat = JDBCInputFormat.buildJDBCInputFormat()
      ...
      .setDBUrl("jdbc:mysql://hadoop120:3306/flinkTest?characterEncodint=utf-8")
      .setPassword("123456")
      .setUsername("root")
    ...
    val goodRow: DataSet[Row] = environment.createInput(inputFormat)

    //将数据写入到hbase
    val result: DataSet[(Text, Mutation)] = goodRow.map(x => {
    ...
    configuration.set(HConstants.ZOOKEEPER_QUORUM, "hadoop100,hadoop110,hadoop120")
