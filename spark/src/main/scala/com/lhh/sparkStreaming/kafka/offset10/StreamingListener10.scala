package com.lhh.sparkStreaming.kafka.offset10
...
/**
  * @description
  * @author: liuhh
  * @date: Created in 2020/2/22 22:40
  * @version 0.0.1
  *          kafka0.10版本 提交偏移量监听器
  */
class StreamingListener10(var stream:InputDStream[ConsumerRecord[String, String]]) extends StreamingListener{
